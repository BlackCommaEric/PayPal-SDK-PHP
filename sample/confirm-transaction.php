...
<?php
    if (isset($_GET['success']) && $_GET['success'] == 'true') { //if a transaction id is present in the URL, do the following:
        ...
        try {
            ...
            ResultPrinter::printResults("Executed Payment", "Payment", $payment->getId(), $execution, $result);
